          ...
          <div className="flex justify-between">
            ...
            <div className="w-full md:w-1/2 flex items-center">
              <div className="px-4">
                ...
                <p>
                  At Oppams Technology, we are dedicated to delivering
                  innovative solutions that empower businesses to thrive in the
                  digital world. With a team of highly skilled professionals and
                  a passion for technology, we strive to exceed our clients'
                  expectations by providing cutting-edge software development,
            ...
            <div className="w-full md:w-1/2 flex items-center">
              <div className="px-4">
                ...
                <p>
                  ...
                  competitive landscape. We aim to build long-lasting
              ...
              <div className="px-4">
                ...
                <ul>
                  ...
                  <li>
                    ...
                    exploring new solutions to solve complex business
                    challenges.
                  </li>
                  <li>
          ...
          <div className="flex mt-10 justify-between">
            <div className="w-full md:w-1/2 flex items-center">
              <div className="px-4">
                ...
                <ul>
                  <li>
                    <strong>Integrity:</strong> Integrity: We conduct business
                    with honesty, transparency, and integrity, building trust
                  ...
                  <li>
                    ...
                    fostering a culture of cooperation and knowledge sharing
